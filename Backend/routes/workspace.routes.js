...
const { createWorkspaceController, getWorkspaceController, getWorkspaceByIdController } = require('../controllers/workspace.controller');
...
workspaceRouter.get('/workspace/:workspaceId', userAuth, getWorkspaceByIdController);
